...
public:
    Controller(const UserValidationPtr& userValidation, GroupDetails* const groupDetails, FriendsModelPtr friendsModel,
        ...
        WarningIndicatorPtr warningIndicator, CurrentStateProviderPtr currentStateProvider, QObject *parent = nullptr);
    ...
    Q_INVOKABLE void removeFriend(const QString& userToRemove);
